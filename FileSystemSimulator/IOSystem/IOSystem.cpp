...
int IOSystem::init(const std::string & i_file_name)
{
	ifstream file;
	...
	if (lSize < Disk::NUMBER_OF_BLOCKS * Sector::BLOCK_SIZE) return wrong_file_size;
...
int IOSystem::save(const std::string & i_file_name)
{
	ofstream fileo;
